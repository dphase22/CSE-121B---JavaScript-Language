...
let mulitplyNumbers = () => {
    ...
    let resultMultiply = multiply(factor1, factor2);
    document.querySelector("#product").value = resultMultiply;
};
document
...
function divideNumbers() {
    ...
    document.querySelector("#quotient").value = resultDivide;
}
document
