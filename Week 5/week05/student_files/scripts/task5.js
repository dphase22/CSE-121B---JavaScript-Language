...
document.querySelector("#message2").textContent = anotherMsg;
...
function output(temples) {
    ...
    temples.forEach((temple) => {
        ...
        let templeDedicate = document.createElement("h4");
        templeDedicate.textContent = temple.templeDedicate;
        ...
        article.appendChild(templeDedicate);
